  ...
  return (
    <section>
        ...
        <p>
          ...
          The goal is to classify news articles, so instances with little to none content are not part of this study.
        </p>
        <p> 
          Next stage deal with rows that do not have a title.
        ...
        <p>
          ...
          It uses white-space as the splitter, and also convert upper case letters to lower case.
        </p>
        <p> 
          Then, stop words were removed from each list of words. 
        ...
        <p>
          ...
          For instance, the words ”Playing”, ”Plays”, ”Played”, and ”Play” are all converted to ”play”.
        </p>
        <p>
        ...
        <p>
          ...
          After splitting the data, the designed pipeline was fitted on the train data, and transformed both training and test sets in order to compute the features column.
        </p>
        <p>
          In this study, Naive Bayes Classifier was utilized in order to classify news. 
          There are three types of Naive Bayes: Multinomial, Bernoulli, and Gaussian.
        </p>
        <p>
          The first one can handle finite discrete data, 
